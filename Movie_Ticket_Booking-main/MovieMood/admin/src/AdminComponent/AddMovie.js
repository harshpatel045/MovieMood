...
function handleClick(event){
 ...
 axios.post('http://localhost:3030/Movie/addMovie',input,{}).then((res)=>{})
 history.push('/')
...
<Form.Row as={Col}>
      <Form.Group  >
         ...
         <textarea class="form-control"  onChange={handleChange} value={input.movieimage} name="movieimage" placeholder="Enter Movie Image Link" style={{width:'500px'}} rows="1" />
     </Form.Group>
    <Form.Group>
