...
function sendMail(data) {
  ...
  let transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "pateldj0077@gmail.com",
      pass: "oagwuueaxflxqxup",
    },
  });
  //setp2
  let mailOptions = {
    from: "pateldj0077@gmail.com",
    to: data.messageto,
    subject: "MovieMood",
    html:
      "<p>Hello,</p><p>Replay Of Your Query:</p><p>Your Query: " +
      data.query +
      "</p><p style='padding: 12px; border-left: 4px solid #d0d0d0; font-style: italic;''>Answer:=&gt; " +
      data.message +
      "</p><p>Best wishes,<br />Movie Mood Team</p> ",
  };
...
function sendBookingMail(data) {
  ...
  let mailOptions = {
    ...
    subject: "MovieMood",
    html:
      "<section style='width: 90%; margin: 100px auto;'><h1 style='font-weight: 900; border-left: 10px solid #fec500; padding-left: 10px; margin-bottom: 30px;'>Ticket</h1><div style='overflow: hidden;'><article style='display: table-row; width: 49%; background-color: #fff; color: #989898; margin-bottom: 10px; border-radius: 4px; position: relative; float: left;'><h2><span style='color: #000000;'><strong>Total Price:</strong>" +
      data.price +
      "</span></h2><section style='display: table-cell; width: 25%; position: relative; text-align: center; border-right: 2px dashed #dadde6;'><strong><span style='color: #000000;'><time><time>" +
      data.date +
      "</time></time></span></strong><h4><span style='color: #000000;'>" +
      data.startTime +
      "</span></h4></section><section style='display: table-cell; width: 90%; font-size: 85%; padding-top: 10px; padding-right: 10px; padding-bottom: 30px;'><h6 style='{{tectcolor: 'red',display:;'>&nbsp; &nbsp; &nbsp; &nbsp;<span style='font-size: 14pt;'> <span style='font-size: 10pt;'>Movie Name:-</span></span><span style='font-size: 10pt;'> <span style='text-decoration: underline;'>" +
      data.movieName +
      "</span></span></h6><h6 style='{{tectcolor: 'red',display:;'>&nbsp; &nbsp; &nbsp; &nbsp; <span style='font-size: 10pt;'><strong>Theater Name:- " +
      data.theaterName +
      "</strong></span></h6><h6><span style='font-size: 10pt;'>&nbsp; &nbsp; &nbsp;Theater Address:- " +
      data.theaterAddress +
      "</span></h6><h6>&nbsp; &nbsp; &nbsp; &nbsp; <span style='font-size: 10pt;'><strong>Seat No:- " +
      data.seats +
      "</strong></span></h6></section></article></div></section>",
  };
  //step3
  transporter.sendMail(mailOptions, function (err, data) {
    if (err) {
...
router.get(
  "/getShow/:city/:name/:day/:month/:year",
  ShowTimingController.getShow
);
...
router.get(
  "/getAllBookingByCustomerName/:userName",
  BookingController.getAllBookingByCustomerName
);
router.get(
  "/getAllBookingByCustomerId/:userId",
